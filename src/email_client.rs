...
mod tests {
    ...
    use secrecy::Secret;
    use wiremock::{matchers as m, Mock, MockServer, Request, ResponseTemplate};
    ...
    impl wiremock::Match for SendEmailBodyMatcher {
        fn matches(&self, request: &Request) -> bool {
            ...
            serde_json::from_slice::<serde_json::Value>(&request.body).map_or_else(
                |_| false,
                |body| {
    ...
    async fn send_email_fires_a_request_to_base_url() {
        ...
        Mock::given(m::header_exists("X-Postmark-Server-Token"))
            .and(m::header("Content-Type", "application/json"))
            .and(m::path("/email"))
            .and(m::method("POST"))
